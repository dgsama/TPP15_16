...
namespace TextCreators
{
    public class WordGenerator
    {
        ...
        public static string GenerateRandomWord()
        {
            ...
            int wordIndex = random.Next(0, RandomWordGeneratorData.words.Length);

            return RandomWordGeneratorData.words[wordIndex];
        }
        ...
        public static string GenerateRandomText(int minWords = 10, int maxWords = 50, int dotsPerWord=13, int commasPerWord=7)
        {
            ...
            for (int i = 0; i < limit; i++)
            {
                ...
                if (i == 0) //First word of the text
                    sb.Append(textInfo.ToTitleCase(RandomWordGeneratorData.words[wordIndex]));
                else
                {
                    ...
                    if (capitalizeNext)
                    {
                        ...
                        sb.Append(" " + RandomWordGeneratorData.words[wordIndex]);
